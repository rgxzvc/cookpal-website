...
export const metadata: Metadata = {
  title: 'Pricing',
  description:
    'CookPal pricing plans. Start free with 5 imports, or go Pro for unlimited recipes and AI-powered recipe ideas.',
}

const features = [
  { name: 'Recipe imports', free: '5 total', pro: 'Unlimited' },
      ...
      <Section padding="lg">
        <div className="text-center mb-16">
          ...
          <p className="text-neutral-600 text-lg max-w-2xl mx-auto">
            Start free with 5 recipe imports. Upgrade to Pro for unlimited imports
            ...
            <ul className="space-y-4 mb-8">
              <li className="flex items-start gap-3">
                ...
                <span className="text-neutral-700">
                  <strong>5 recipe imports</strong> total
                </span>
              </li>
              <li className="flex items-start gap-3">
                <Check className="w-5 h-5 text-primary-500 flex-shrink-0 mt-0.5" />
